                            ...
                            <div className="list-group">
                                {products.map((item) => (
                                    <div
                                        ...
                                        <center>
                                            <h3 className="text-primary">{item.nameProduct}</h3>
                                        </center>
                                        <h5 className="text-secundary">Descripcion del producto: {item.description}</h5>
                                        <h5 className="text-info">Unidades disponibles: {item.stocks} </h5>
                                       {/* <h5 className="text-dark">{item.imagePath} </h5>*/}

                                        <img src={imageReact(`./${item.imagePath.split('\\').pop().split('/').pop()}`)} 
                                            alt={item.nameProduct} width="20%" />
                                        {/* <img src={imageReact(`./${item.imageName}`)} alt={item.nameProduct} />*/}
